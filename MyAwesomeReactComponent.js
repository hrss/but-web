      ...
      render() {
        return (
          <button
            ...
            onClick={this.handleClick}><img src="ic_navigate_before_black_24dp_1x.png"/></button>
        )
      },
      handleClick(e) {
        e.preventDefault();
      ...
      render() {
        return (
          <button
            ...
            onClick={this.handleClick}><img src="ic_navigate_next_black_24dp_1x.png"/></button>
        )
      },
      handleClick(e) {
        e.preventDefault();
